...
Qwen3_5Model.forward()
  ...
  └─ inputs_embeds = self.get_input_embeddings()(input_ids)
     ...
     │
     │  输入: input_ids (1, 272) — 整数序列
     │  输出: inputs_embeds (1, 272, 4096) — 浮点向量序列
     │
     │  其中:
...
# input_ids: (1, 272) int64
# 输出: (1, 272, 4096) float16/bfloat16
```
...
| 261 | `\n` | 198 | 0 | 换行 |
| 262-267 | `描述这张图片` | varies | 0 | 用户文本 |
| 268 | `<\|im_end\|>` | 151645 | 0 | 对话轮次结束 |
| 269 | `\n` | 198 | 0 | 换行 |
| 270 | `<\|im_start\|>` | 151644 | 0 | 助手轮次开始 |
| 271 | `assistant` | 14776 | 0 | 角色标识 |
